      ...
      <div ref={ref} className={`max-w-5xl mx-auto transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-3xl font-bold text-white">Technical Impact</h3>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-3xl font-bold text-white">Reliability & Resilience</h3>
          </div>
          <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700 card-hover">
            <p className="text-slate-300 text-lg leading-relaxed mb-4">
            ...
            <div className="mt-6 space-y-4">
              <div>
                <h4 className="text-xl font-semibold text-white mb-2">Error Handling</h4>
              ...
              <div>
                <h4 className="text-xl font-semibold text-white mb-2">Cost Normalization</h4>
                <p className="text-slate-300">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-3xl font-bold text-white">Quality & Engineering Standards</h3>
          </div>
          <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700 card-hover">
            <p className="text-slate-300 text-lg leading-relaxed mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-slate-900/50 rounded-lg">
                <div className="text-2xl font-bold text-indigo-400 mb-2">Python</div>
                <p className="text-slate-300 text-sm">Type-hinting throughout</p>
                <p className="text-slate-500 text-xs mt-1">Full type annotations</p>
              </div>
              <div className="text-center p-6 bg-slate-900/50 rounded-lg">
                <div className="text-2xl font-bold text-indigo-400 mb-2">Exceptions</div>
                <p className="text-slate-300 text-sm">Specific handling</p>
                <p className="text-slate-500 text-xs mt-1">Targeted error management</p>
              </div>
              <div className="text-center p-6 bg-slate-900/50 rounded-lg">
                <div className="text-2xl font-bold text-indigo-400 mb-2">CI/CD</div>
                <p className="text-slate-300 text-sm">Validation pipeline</p>
                <p className="text-slate-500 text-xs mt-1">Automated testing</p>
              </div>
            </div>
            <div className="mt-6 p-4 bg-indigo-600/10 rounded-lg border border-indigo-500/30">
              <p className="text-slate-300 text-sm">
                <strong className="text-indigo-400">Code Quality:</strong> All code follows Google's Python style guide with comprehensive type hints, specific exception handling for different error scenarios, and full CI/CD validation to ensure reliability and maintainability.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700 card-hover">
            <div className="space-y-4">
              <div>
                <h4 className="text-xl font-semibold text-white mb-2">LLM Observability Development</h4>
                <p className="text-slate-300">
              ...
              <div>
                <h4 className="text-xl font-semibold text-white mb-2">Error Handling & Resilience</h4>
                <p className="text-slate-300">
              ...
              <div>
                <h4 className="text-xl font-semibold text-white mb-2">Cost Normalization System</h4>
                <p className="text-slate-300">
              ...
              <div>
                <h4 className="text-xl font-semibold text-white mb-2">Code Quality & Standards</h4>
                <p className="text-slate-300">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-3xl font-bold text-white">Impact & Outcomes</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 text-center card-hover">
              <div className="text-3xl font-bold text-indigo-400 mb-2">Official</div>
              <p className="text-slate-300">Google Repository</p>
              <p className="text-sm text-slate-500 mt-1">Accepted into cookbook</p>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 text-center card-hover">
              <div className="text-3xl font-bold text-indigo-400 mb-2">Real-time</div>
              <p className="text-slate-300">Cost Tracking</p>
              <p className="text-sm text-slate-500 mt-1">USD monitoring for Gemini</p>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 text-center card-hover">
              <div className="text-3xl font-bold text-indigo-400 mb-2">Production</div>
              <p className="text-slate-300">Ready Utility</p>
              <p className="text-sm text-slate-500 mt-1">Reusable observability tool</p>
            </div>
          </div>
        </div>
