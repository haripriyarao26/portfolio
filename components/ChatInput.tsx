    ...
    <div className="border-t border-[#565869] bg-[#343541] p-4">
      <div className="max-w-3xl mx-auto flex gap-2 items-end">
        <textarea
          ...
          className="flex-1 resize-none bg-[#40414f] text-[#111827] placeholder-gray-400 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#19c37d] max-h-32 overflow-y-auto"
          rows={1}
          disabled={disabled}
          style={{
            scrollbarWidth: 'thin',
        ...
        >
          <Send size={20} className="text-[#111827]" />
        </button>
      </div>
    </div>
  );
