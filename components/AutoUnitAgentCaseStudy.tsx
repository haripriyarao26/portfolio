      ...
      <div ref={ref} className={`max-w-5xl mx-auto transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-3xl font-bold text-white">What I Built</h3>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-3xl font-bold text-white">Safety & Guardrails</h3>
          </div>
          <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700 card-hover">
            <p className="text-slate-300 text-lg leading-relaxed">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-3xl font-bold text-white">Why It’s Interesting</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 text-center card-hover">
              <div className="text-3xl font-bold text-indigo-400 mb-2">Agentic</div>
              <p className="text-slate-300">Closed-loop testing</p>
              <p className="text-sm text-slate-500 mt-1">Execution-driven debugging</p>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 text-center card-hover">
              <div className="text-3xl font-bold text-indigo-400 mb-2">Safe</div>
              <p className="text-slate-300">Isolated sandbox</p>
              <p className="text-sm text-slate-500 mt-1">No repo pollution</p>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 text-center card-hover">
              <div className="text-3xl font-bold text-indigo-400 mb-2">Practical</div>
              <p className="text-slate-300">TypeScript + Jest</p>
              <p className="text-sm text-slate-500 mt-1">Real-world dev flow</p>
            </div>
          </div>
        </div>
